    ...
    return (
        <>
                ...
                <div className='flex flex-col w-full md:w-[50%] gap-y-12'>
                    <div className='h-fit flex flex-col gap-y-3'>
                        <div className='relative overflow-hidden'>
                            <img className='w-full transition-transform duration-500 ease-in-out hover:scale-110' src={Images.blog1} alt="" />
                        </div>
                        <h1 className='text-lg md:text-xl font-bold'>Black Friday Guide: Best Sales & Discount Codes</h1>
                    ...
                    <div className='h-fit flex flex-col gap-y-3'>
                        <div className='relative overflow-hidden'>
                            <img className='w-full transition-transform duration-500 ease-in-out hover:scale-110' src={Images.blog2} alt="" />
                        </div>
                        <h1 className='text-lg md:text-xl font-bold'>The White Sneakers Nearly Every Fashion Girl Owns</h1>
                        <h6 className='text-sm md:text-base'>by fashe-theme Admin | crafts, street style | 0 Comments</h6>
                        <p className='text-sm md:text-base'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sed turpis sed lorem dignissim vulputate nec cursus ante. Nunc sit...</p>
                        <button className='flex items-center gap-x-2 text-sm md:text-base'>
                            Continue Reading <FaLongArrowAltRight />
                        </button>
            ...
            <div className='flex items-center justify-center gap-x-4 mt-6'>
                <button onClick={() => navigate("/blog")} className='bg-black text-white rounded-full w-10 h-10 flex items-center justify-center'>
                    1
                </button>
                <button onClick={() => navigate("/blog2")} className='bg-white text-black hover:bg-black hover:text-white rounded-full w-10 h-10 flex items-center justify-center'>
                    2
                </button>
            </div>
        </>
